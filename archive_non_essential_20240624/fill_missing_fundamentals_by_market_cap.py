#!/usr/bin/env python3
"""
Fill Missing Fundamentals by Market Cap Priority
Identifies tickers missing fundamental data and fetches them largest to smallest
"""
...
class MissingFundamentalsFiller:
    """Fill missing fundamental data by market cap priority"""
    ...
    def __init__(self):
        ...
        logger.info("Missing Fundamentals Filler initialized")
    ...
    def get_missing_fundamentals_tickers(self) -> List[Dict]:
        """Get tickers missing fundamental data, ordered by market cap"""
        try:
            # Get tickers with no fundamental data or missing key fields
            query = """
            ...
            if tickers:
                logger.info("Top 20 missing tickers by market cap:")
            ...
            logger.error(f"Error getting missing fundamentals tickers: {e}")
            return []
    ...
    def process_missing_fundamentals(self, limit: int = None) -> Dict[str, Any]:
        """Process tickers missing fundamental data by market cap priority"""
        logger.info("🚀 Starting missing fundamentals filling process")
        ...
        # Get tickers missing fundamental data
        ticker_info_list = self.get_missing_fundamentals_tickers()
        if limit:
        ...
        logger.info(f"Processing {self.total_tickers} tickers missing fundamental data")
        ...
        logger.info("✅ Missing fundamentals filling completed")
...
def main():
    """Main function to run the missing fundamentals filling process"""
    print("🚀 Starting Missing Fundamentals Filling Process")
    print("=" * 60)
    print("Processing companies missing fundamental data by market cap (largest first)")
    print()
    
    try:
        filler = MissingFundamentalsFiller()
        
        # First, show what's missing
        missing_tickers = filler.get_missing_fundamentals_tickers()
        ...
        print("  1. Test with top 10 missing companies")
        print("  2. Test with top 25 missing companies") 
        print("  3. Test with top 50 missing companies")
        print("  4. Test with top 100 missing companies")
        print("  5. Process all missing companies (use with caution)")
        ...
        try:
            ...
            if choice == '1':
                ...
                print("Invalid choice, using top 25 missing companies as default")
                limit = 25
            
            # Process missing tickers by market cap
            results = filler.process_missing_fundamentals(limit=limit)
            ...
            # Show successful updates (top by market cap)
            ...
            # Show failed updates (top by market cap)
            ...
            print("\n✅ Missing fundamentals filling completed")
