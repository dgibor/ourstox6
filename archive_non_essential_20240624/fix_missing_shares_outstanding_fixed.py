#!/usr/bin/env python3
"""
Fix stocks missing shares outstanding data (Fixed SQL error)
"""
...
def fix_missing_shares_outstanding():
    ...
    print("🔧 FIXING MISSING SHARES OUTSTANDING (FIXED)")
    print("=" * 50)
    
    db = DatabaseManager()
    fmp = FMPService()
    
    # Get stocks missing shares outstanding (fixed SQL query)
    missing_query = """
    SELECT cf.ticker 
