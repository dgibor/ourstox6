#!/usr/bin/env python3
"""
Monitor the progress of company fundamentals update
"""
...
def monitor_fundamentals_update():
    """Monitor the progress of company fundamentals update"""
    
    print("📊 MONITORING COMPANY FUNDAMENTALS UPDATE")
    print("=" * 50)
    ...
    if sample_data:
        ...
        print(f"   -------|------------|------------|------------|------------")
        for ticker, revenue, net_income, ebitda, market_cap in sample_data:
    ...
    print(f"   • Large companies are processed first")
    print(f"   • Estimated completion: {total_stocks * 2 / 60:.1f} minutes total")

if __name__ == "__main__":
    monitor_fundamentals_update() 