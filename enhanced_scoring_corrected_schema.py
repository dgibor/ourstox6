#!/usr/bin/env python3
"""
Enhanced Stock Scoring with VWAP & Support/Resistance - CORRECTED SCHEMA
Uses actual database column names and balanced weights
"""
...
class CorrectedEnhancedScorer:
    """Enhanced stock scorer with corrected schema and balanced weights"""
    ...
    def calculate_fundamental_health(self, fundamental: Dict) -> float:
        """Calculate fundamental health score (0-100) using available data"""
        try:
            score = 0
            factors = 0
            ...
            if fundamental.get('net_income_ttm') and fundamental['net_income_ttm'] > 0:
                ...
                score += 5   # Unprofitable but data available
                factors += 1
    ...
    def test_scoring_system(self, test_tickers: List[str] = None):
        ...
        # Display results
        print("=" * 80)
        print("ENHANCED STOCK SCORING RESULTS WITH CORRECTED SCHEMA & BALANCED WEIGHTS")
        print("=" * 80)
...
def main():
    ...
    scorer = CorrectedEnhancedScorer()
