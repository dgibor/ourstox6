"""
Test Ratio Accuracy with Real Data
...
from self_calculated_fundamental_ratio_calculator import SelfCalculatedFundamentalRatioCalculator
...
class APIFetcher:
    """Fetch real API data for comparison"""
    
    def __init__(self):
        self.yahoo_base_url = "https://query2.finance.yahoo.com/v10/finance/quoteSummary"
    
    def get_yahoo_finance_ratios(self, ticker: str) -> Dict[str, float]:
        ...
        try:
            ...
            logger.error(f"Error getting Yahoo Finance ratios for {ticker}: {e}")
            return {}
...
def test_ratio_accuracy():
    ...
    for ticker in test_tickers:
        ...
        # Get API ratios
        api_ratios = api_fetcher.get_yahoo_finance_ratios(ticker)
